 ...
 */
    ...
    (() => {
                ...
                function getHeight(showMoreBlock, showMoreContent) {
                    ...
                    if (showMoreType === "items") {
                        ...
                        for (let index = 1; index < showMoreItems.length; index++) {
                            ...
                            hiddenHeight += parseInt(window.getComputedStyle(showMoreItem).getPropertyValue("margin-top"));
                            hiddenHeight += parseInt(window.getComputedStyle(showMoreItem).getPropertyValue("margin-bottom"));
        ...
        function initSliders() {
            let cardsSliders = document.querySelectorAll(".item-slider");
            if (cardsSliders) cardsSliders.forEach((e => {
                let prevButton = e.querySelector(".slider-btn-prev");
                let nextButton = e.querySelector(".slider-btn-next");
                let pagination = e.querySelector(".item-slider__pagintaion");
                new core(e.querySelector(".item-slider__slider"), {
            ...
            if (document.querySelector(".item__slider")) {
                let swiperThumbs = new core(".item__slider-thumb", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 3,
        ...
        if (cards) if (isMobile.any()) cards.forEach((e => {
